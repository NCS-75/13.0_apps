...
class IrModel(models.Model):
    ...
    def name_search(self, name, args, operator='ilike', limit=100):
        ...
        return super(IrModel, self).name_search(name, args=args, operator=operator, limit=limit)
...
class IrModelFields(models.Model):
    ...
    def name_search(self, name, args, operator='ilike', limit=100):
        ...
        return super(IrModelFields, self).name_search(name, args=args, operator=operator, limit=limit)
